#######################################################################
# nonhydrostatic_bg_advection_comparison.jl
#
# 5 days of NONHYDROSTATIC evolution at 150 m horizontal spacing
...
for advect_background in (false, true)
    ...
    @info "Nonhydrostatic run: $case (advect_background = $advect_background)"
    ...
    jldsave("nonhydrostatic_$(case)_metadata.jld2"; parameters)
